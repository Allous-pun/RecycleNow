...
const teamMembers = [
  {
    ...
    bio: 'Faith has over 5 years of experience in the tech industry, leading teams and building innovative products.',
    socialLinks: {
  ...
  },
  {
    ...
    bio: 'Fidel is a seasoned Engineering Manager with extensive experience in overseeing development teams and implementing complex systems.',
    socialLinks: {
  ...
  },
  {
    ...
    bio: 'Suileiman specializes in mobile application development with over a decade of experience in creating user-friendly mobile solutions.',
    socialLinks: {
  ...
  },
  {
    ...
    bio: 'Aloyce is a marketing expert with a proven track record of leading global campaigns and enhancing brand visibility.',
    socialLinks: {
